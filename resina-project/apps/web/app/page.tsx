        ...
        <header className="flex flex-wrap items-center justify-between gap-3 px-4 py-4 sm:px-5 md:px-10 md:py-5">
          <a className="flex items-center gap-3" href="#">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Image src="/images/Sta Rita Icon.png" alt="Sta. Rita icon" width={42} height={42} priority className="mt-0.5 h-auto w-auto sm:h-12 sm:w-12" />
            </div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
              ...
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v12m0 0l4-4m-4 4-4-4M5 19h14" />
                </svg>
                Download App
              </a>
            </div>
